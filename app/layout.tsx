...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      <head>
        <meta name="google-adsense-account" content="ca-pub-3556606235552037" />
        <Script
          async
          src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3556606235552037"
          crossOrigin="anonymous"
        />
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-35JCEZSKHN"
